...
System.register([], function (_export, _context) {
  ...
  var MODE_AVAIL, MODE_CP, MODE_SYSTEM, MODE_STATUS, SEV_NOT_CLASSIFIED, SEV_INFORMATION, SEV_WARNING, SEV_AVERAGE, SEV_HIGH, SEV_DISASTER, SHOW_ALL_TRIGGERS, SHOW_ALL_EVENTS, SHOW_OK_EVENTS, DATAPOINT_VALUE, DATAPOINT_TS, TRIGGER_SEVERITY;
  return {
    setters: [],
    execute: function () {
      _export('MODE_AVAIL', MODE_AVAIL = 0);

      _export('MODE_AVAIL', MODE_AVAIL);

      _export('MODE_CP', MODE_CP = 1);

      _export('MODE_CP', MODE_CP);

      _export('MODE_SYSTEM', MODE_SYSTEM = 2);

      _export('MODE_SYSTEM', MODE_SYSTEM);

      _export('MODE_STATUS', MODE_STATUS = 3);

      _export('MODE_STATUS', MODE_STATUS);
